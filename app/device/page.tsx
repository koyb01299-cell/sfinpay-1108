    ...
    return (
        <div className="min-h-screen bg-[#f0fdfa] text-[#0b2723] pt-32">
            ...
            <section className="py-24 px-6 md:px-16 bg-[#ecfdf5] relative overflow-hidden text-center">
                <motion.h2 {...fadeUp(0)} className="text-4xl font-bold mb-12 text-[#0b2723]">
                    단말기 라인업
                </motion.h2>
                ...
                <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
                    {[
                        ...
                        <motion.div
                            key={i}
                            {...fadeUp(i * 0.2)}
                            className="bg-white border border-[#a7f3d0]/60 rounded-2xl shadow-sm hover:shadow-[0_0_25px_rgba(16,185,129,0.15)] transition-all max-w-sm"
                        >
                            <img
                                src={d.img}
                                alt={d.title}
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-[#1e3a34]/80 leading-relaxed">{d.desc}</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {[
                        ...
                        <motion.div
                            key={i}
                            {...fadeUp(i * 0.1)}
                            className="p-8 bg-white border border-[#a7f3d0]/60 rounded-2xl hover:shadow-[0_0_25px_rgba(16,185,129,0.15)] transition-all"
                        >
            ...
            <section className="py-24 px-6 md:px-16 bg-[#ecfdf5] text-center">
                <motion.h2 {...fadeUp(0)} className="text-4xl font-bold mb-10 text-[#0b2723]">
                    단말기 관리, 클라우드로 한눈에
                </motion.h2>
                <motion.div
                    {...fadeUp(0.2)}
